...
public class DashboardController {
    ...
    @PreAuthorize("hasAuthority('MIN_USER', 'SEC_EDU')")
    ...
    @PreAuthorize("hasAuthority('MIN_USER', 'SEC_EDU', 'DIRECT_TEACHER')")
    ...
    @PreAuthorize("hasAuthority('MIN_USER', 'SEC_EDU', 'DIRECT_TEACHER', 'TEACHER')")
    ...
    @PreAuthorize("hasAuthority('MIN_USER', 'SEC_EDU', 'DIRECT_TEACHER', 'TEACHER', 'STUDENT')")
